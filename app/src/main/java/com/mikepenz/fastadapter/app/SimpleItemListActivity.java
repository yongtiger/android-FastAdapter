...
public class SimpleItemListActivity extends AppCompatActivity implements ItemTouchCallback, ItemFilterListener<SimpleItem> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //
//        FastScrollIndicatorAdapter fastScrollIndicatorAdapter = new FastScrollIndicatorAdapter();///[FIX#MaterialScrollBar]
        itemAdapter = items();
...
//        recyclerView.setAdapter(fastScrollIndicatorAdapter.wrap(fastAdapter));///[FIX#MaterialScrollBar]
